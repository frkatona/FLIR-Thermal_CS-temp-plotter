...
df1['Position_cm'] = df1['Position'] / 40
df2['Position_cm'] = df2['Position'] / 40
df3['Position_cm'] = df3['Position'] / 40
...
plt.plot(x_values, exp_decay(x_values, *params1), color=color_low, linestyle='--')
plt.plot(x_values, exp_decay(x_values, initial_guess1[0], initial_guess1[1], initial_guess1[2]), color=color_high, linestyle='-')
# plt.plot(x_values, exp_decay(x_values, *params2), color=color_high, linestyle='--')
plt.plot(x_values, exp_decay(x_values, *params3), color=color_mid, linestyle='--')

plt.xlabel('time /s', fontsize=40)
plt.ylabel('height (cm)', fontsize=40)
