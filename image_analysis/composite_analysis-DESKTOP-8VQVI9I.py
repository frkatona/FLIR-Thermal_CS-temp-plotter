...
=======
>>>>>>> 95c7f3e07ea287a310be3a771d43881e5f048044
...
<<<<<<< HEAD
        ...
        # show temperature color legend
        cbar = plt.colorbar(ax.imshow(smoothed_data, cmap='hot', interpolation='nearest'))
        cbar.set_label('Temperature (°C)')
        

        # save image to file
        plt.savefig(f"exports/thermal_images/{direction}_{filename}.png", bbox_inches='tight', pad_inches=0)
